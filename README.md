...
| <a name="input_enable_efs_cmk_encryption"></a> [enable\_efs\_cmk\_encryption](#input\_enable\_efs\_cmk\_encryption) | Enable customer managed KMS encryption for EFS. | `bool` | `true` | no |
